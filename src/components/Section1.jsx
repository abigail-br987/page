    ...
    return(
        <section style={sectionStyle} class="flexbox-section">
            <div class="left-container">
                <img class="left-image border" src="src/assets/group-photo1.jpeg" alt="Group Photo"></img>
            </div>
            <div class="right-container">
                <img class="right-image" src="src/assets/logo-foreveryoung2.png" alt="Logo"></img>
